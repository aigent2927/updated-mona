...
function Lightbox({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative max-h-[62vh] max-w-[70vw] md:max-h-[88vh] md:max-w-[85vw]"
      ...
      >
        ...
        <img
          src={src}
          alt={alt}
          className="block w-auto h-auto max-h-[62vh] max-w-[70vw] md:max-h-[88vh] md:max-w-[85vw] object-contain"
        />
